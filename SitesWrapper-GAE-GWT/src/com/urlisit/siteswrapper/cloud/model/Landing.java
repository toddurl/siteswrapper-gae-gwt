 ...
 */
@PersistenceCapable
public class Landing implements IsSerializable {
   ...
   * during and after an update of the configuration. Under normal conditions, (not during an update)
   * revision has a value of either current or a date (in SimpleDateFormat) when it was archived as
   * the object of an updateLandingConfiguration POST request. During the updateLandingConfiguration
   * POST request, the current configuration is marked as previous and the new Landing configuration
   * object is created and marked as current. Upon successful creation of the new Landing page
   * configuration object (marked as current) the old Landing object (marked as previous) is archived
   * by setting the value of revision to the current Date/Time in SimpleDateFormat. If the
   * update(Site|Page|Landing|Information)Configuration operation is interrupted or fails for any
   * reason, the configuration is rolled back by deleting any objects marked as current and setting
  ...
  /**
   * Value portion of name=value pairs used to arbitrarily assign arbitrary specifications and values
   * to a landing page
   */
  @Persistent
  ...
  /**
   * Name portion of name=value pairs used to arbitrarily assign arbitrary specifications and values
   * to a landing page
   */
  @Persistent
